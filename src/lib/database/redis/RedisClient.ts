...
export class RedisClient extends Redis {
	 ...
	 */
	public async add(key: string, obj: any): Promise<boolean | null> {
	 ...
	 * @returns If the operation succeeded
	 */
	public async addEx(key: string, obj: any, ttl: number): Promise<boolean | null> {
	 ...
	 * @returns If the operation succeeded
	 */
	public async delete(key: string): Promise<boolean | null> {
	 ...
	 * @returns If the operation succeeded
	 */
	public async deleteMany(keys: string[]): Promise<boolean | null> {
	 ...
	 * @returns If the operation succeeded
	 */
	public async addHash(key: string, obj: any): Promise<boolean | null> {
	 ...
	 * @returns The data associated with the key
	 */
	public async fetchHash(key: string): Promise<Record<string, string> | null> {
	 ...
	 */
	public async fetchManyHash(setKey: string): Promise<Record<string, string>[] | null> {
		const result = await Result.fromAsync(async () => {
	 ...
	 * @returns If the operation succeeded
	 */
	public async removeHash(key: string, fields: string[]): Promise<boolean | null> {
	 ...
	 * @returns If the operation succeeded
	 */
	public async addSet(key: string, member: string): Promise<boolean | null> {
	 ...
	 * @returns The data associated with the key
	 */
	public async fetchSet(key: string): Promise<string[] | null> {
	 ...
	 * @returns If the operation succeeded
	 */
	public async removeSet(key: string, member: string): Promise<boolean | null> {
	 ...
	 */
	public async isMemberOfSet(key: string, member: string): Promise<boolean | null> {
