...
@ApplyOptions<KBotCommandOptions>({
	...
	helpEmbed: (builder) => {
		return builder //
			.setName('Twitch')
			.setDescription('Add, remove, or edit Twitch subscriptions.')
			.setSubcommands([
				{ label: '/twitch subscribe <account>', description: 'Subscribe to a new account' }, //
				{ label: '/twitch unsubscribe <account>', description: 'Unsubscribe from an account' },
				{ label: '/twitch set <account> [enabled] [message] [channel] [role]', description: 'Set Twitch notification settings' },
				{ label: '/twitch unset <account> [message] [channel] [role]', description: 'Unset Twitch notification settings' },
				{ label: '/twitch toggle <value>', description: 'Enable or disable the twitch module' },
				{ label: '/twitch settings', description: 'Show the current settings' }
			]);
	}
})
export class NotificationsCommand extends KBotCommand<TwitchModule> {
