		...
		<div class="flex grow flex-col gap-4 lg:w-6/12">
			...
			<LegalSection title="1. Agreement to Terms">
				<p>
					...
					personally or on behalf of an entity (“you”) and KBot ("Company", "we", "us", or "our"),
			...
			<LegalSection title="12. Privacy Policy">
				<p>
					...
					<a href="/privacy">https://kbot.ca/privacy</a>. By using the Site, you agree to be bound
					by our Privacy Policy, which is incorporated into these Terms of Use. Please be advised
					the Site is hosted in the United States. If you access the Site from any other region of
					...
					agree to have your data transferred to and processed in the United States. Further, we do
					not knowingly accept, request, or solicit information from children or knowingly market to
					children. Therefore, in accordance with the U.S. Children’s Online Privacy Protection Act,
					if we receive actual knowledge that anyone under the age of 13 has provided personal
