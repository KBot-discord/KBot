<script lang="ts">
	...
	import LegalSection from '$components/LegalSection.svelte';
</script>
		...
		<div class="flex grow flex-col gap-4 lg:w-6/12">
			...
			<LegalSection title="1. Agreement to Terms">
				<p>
					...
					whether personally or on behalf of an entity (“you”) and KBot ("Company", "we",
					"us", or "our"), concerning your access to and use of the
					<span class="text-[#FFFFFF] hover:text-[#60A5FA]">
						<a href="/">https://kbot.ca</a>
					</span>
			...
			<LegalSection title="3. User Representatives">
				<p>
					...
					agree to comply with these Terms of Use; (4) you are not under the age of 13;
					(5) you are not a minor in the jurisdiction in which you reside, or if a minor,
					you have received parental permission to use the Site; (6) you will not access
					the Site through automated or non-human means, whether through a bot, script, or
			...
			<LegalSection title="12. Privacy Policy">
				<p>
					...
					<a href="/privacy">https://kbot.ca/privacy</a>. By using the Site, you agree to
					...
					Privacy Protection Act, if we receive actual knowledge that anyone under the age
			...
			<LegalSection title="15. Governing Law">
				<p>
					These Terms shall be governed by and defined following the laws of Canada. KBot
			...
			<LegalSection title="24. Contact Us">
				...
				<p class="flex flex-col">
					<a href="mailto: support@kbot.ca">support@kbot.ca</a>
